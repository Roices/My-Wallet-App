...
extension CustomSegmentedControl {
    public func updateView() {
     ...
     func configSelectorView() {
        ...
        Line = UIView(frame: CGRect(x: 0, y: self.frame.height + 3.2, width: LineWidth, height: 0.75))
        Line.backgroundColor = LineViewColor
      
        selectorView = UIView(frame: CGRect(x: 0, y: self.frame.height, width: selectorWidth, height: 3.5))
     ...
     func createButton() {
        ...
        for buttonTitle in buttonTitles {
            ...
            button.titleLabel?.font = UIFont(name: "System Bold", size: 10)
